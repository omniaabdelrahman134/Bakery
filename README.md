...
- Working with floats and layout positioning
...
- Refactor layout using Flexbox or CSS Grid
- Add interactivity using JavaScript

---

This project represents the beginning of my journey in web development 🚀
